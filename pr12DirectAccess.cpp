...
class DirectAccess
{
    public:
        ...
        void insertRecord()
        {
            ...
            fstream file;
            file.open("StudentDirect.txt",ios::in|ios::out|ios::binary);
                cout<<"\nOpened";

            // if(!file)
            // {
                // fstream cFile("StudentDirect",ios::out|ios::binary);
                // cFile.close();

            //     file.open("StudentDirect",ios::in|ios::out|ios::binary);
            //     cout<<"\nOpened";
            // }
        ...
        void deleteRecord()
        {
            fstream file("StudentDirect",ios::in|ios::out|ios::binary);
            if(!file)
            {
                cout<<"\nFile not found !";
                return;
        ...
        {
            fstream file;
            file.open("StudentDirect.txt",ios::in|ios::binary);
